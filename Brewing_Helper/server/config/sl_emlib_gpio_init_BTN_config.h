#ifndef SL_EMLIB_GPIO_INIT_BTN_CONFIG_H
#define SL_EMLIB_GPIO_INIT_BTN_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_BTN_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_BTN_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_BTN_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_BTN_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_BTN
// $[GPIO_SL_EMLIB_GPIO_INIT_BTN]
#define SL_EMLIB_GPIO_INIT_BTN_PORT              gpioPortC
#define SL_EMLIB_GPIO_INIT_BTN_PIN               7
// [GPIO_SL_EMLIB_GPIO_INIT_BTN]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_BTN_CONFIG_H
