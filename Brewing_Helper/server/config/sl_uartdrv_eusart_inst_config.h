...
#define SL_UARTDRV_EUSART_INST_FLOW_CONTROL_TYPE uartdrvFlowControlHw
...
#define SL_UARTDRV_EUSART_INST_PERIPHERAL        EUART0
...
#define SL_UARTDRV_EUSART_INST_CTS_PIN           8

// EUART0 RTS on PA07
#define SL_UARTDRV_EUSART_INST_RTS_PORT          gpioPortA
#define SL_UARTDRV_EUSART_INST_RTS_PIN           7
// [EUSART_SL_UARTDRV_EUSART_INST]$
// <<< sl:end pin_tool >>>
