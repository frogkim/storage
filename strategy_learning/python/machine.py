...
class MACHINE:
    ...
    def _build_network(self, lines=20):
        with tf.variable_scope(self.net_name):
            ...
            test1_weight_3 = tf.get_variable(self.weight_name, shape=[self.neural_size, self.output_size],
                                 initializer = tf.keras.initializers.glorot_uniform())
            ...
            self.Qpred_1      = tf.nn.tanh(tf.matmul(self.test1_layer2, test1_weight_3))
